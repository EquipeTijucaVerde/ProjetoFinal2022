...
function enviaremail($nomedestinatario, $emaildestinatario, $campoassunto, $texto, $campomenssagem){
...
try {
   ...
   // $mail->SMTPDebug = SMTP::DEBUG_SERVER;
    ...
    echo 'Solicitação de recompensa enviada com sucesso.<br><br> Por favor aguarde um retorno da Equipe TijucaVerde';
} catch (Exception $e) {
