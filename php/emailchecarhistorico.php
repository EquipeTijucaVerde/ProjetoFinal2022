...
function enviaremail($nomedestinatario, $emaildestinatario, $campoassunto, $texto){
...
try {
   ...
   // $mail->SMTPDebug = SMTP::DEBUG_SERVER;
    ...
    //Remetente
    $mail->setFrom('tijucaverde1303@gmail.com', 'Equipe Tijuca Verde');
    ...
    echo 'Sua solicitação para a checagem do seu histórico foi enviada com sucesso.<br><br> Por favor aguarde um retorno da Equipe TijucaVerde';
} catch (Exception $e) {
