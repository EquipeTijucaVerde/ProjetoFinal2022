...
<link rel="stylesheet" href="../css/tabela2022.css">
<link rel="stylesheet" href="../css/menu2022.css">
<link rel="stylesheet" href="../css/padrao2022.css">
</head>
<body>
...
<div class="pagination">
    <?php for($i=1; $i <= $contagem; $i++) {
            echo "<a href='controlarusuarios2022.php?pag=$i'>$i</a>";
    } 
	?>   
</div>  
            <a href="usuariocadastrartela.php"><img src="../imagens/policia.png" alt="Incluir Usuário"></a>
    </div>
<div class="footer">
  <p>Projeto Final</p>
</div>
